...
/**
 * Settings bottom sheet for SportzxPlugin.
 * Mirrors SKTechProvider's Settings.kt exactly but references SportzxPlugin.
 */
class SportzxSettings(
    private val plugin: SportzxPlugin,
    ...
    private fun getPlaylistRow(playlistName: String): RelativeLayout {
        ...
        checkBox.setOnCheckedChangeListener { _, checked ->
            if (checked) enabledPlaylists.add(playlistName) else enabledPlaylists.remove(playlistName)
        }
